<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="contactUS.aspx.cs" Inherits="project7.WebForm5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-xxl py-5">
        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                <br /> <asp:Button ID="Button1" class="SendEmailButton" runat="server" Text="Send Email"   />
            </div>
        </div>
    </form>
